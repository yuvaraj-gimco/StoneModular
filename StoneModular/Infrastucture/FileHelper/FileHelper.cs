...
namespace Infrastructure.Repositories
{
    public class FileHelper
    {
        ...
        public FileHelper(IBlobStorageRepository ibs)
        {
            this.blobStorage = ibs;
        
        }
    //    public Object UploadMaterial(HttpContextBase ContentBase, List<ViewDataUploadFilesResult> resultList, string ContainerName)
    //    {
