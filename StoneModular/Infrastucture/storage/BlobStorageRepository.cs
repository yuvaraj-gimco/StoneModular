...
namespace Infrastructure.Repositories.Storage
{
    public class BlobStorageRepository : IBlobStorageRepository
    {
        ...
        public string _PotDesignFilesandGetUrl(HttpPostedFileBase httpPostedFile, string ContainerName)
        {
        ...
        //}
        public string _PostAdminPhotosWithRezie(HttpPostedFileBase httpPostedFile, byte[] data,string container)
        {
            CloudBlobClient blobClient = _connection.storageClient;
